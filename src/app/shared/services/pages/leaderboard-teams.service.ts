...
export class LeaderboardTeamsService {
  ...
  teams: Team[] = [
    ...
    },
    {
      ...
      members: 159936,
      urlAvatar:
        'https://pancakeswap.finance/images/teams/fearsome-flippers-md.png',
      urlSfondo:
        'https://pancakeswap.finance/images/teams/fearsome-flippers-bg.svg',
      fontColor: 'ffffff',
    },
    {
      id: 3,
      ...
      members: 323067,
      urlAvatar:
        'https://pancakeswap.finance/images/teams/chaotic-cakers-md.png',
      urlSfondo:
        'https://pancakeswap.finance/images/teams/chaotic-cakers-bg.svg',
      fontColor: '191326',
    },
  ];
}
